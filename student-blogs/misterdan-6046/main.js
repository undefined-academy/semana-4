...
const contenedorFecha = document.querySelectorAll(".card-footer-time");
// contenedorFecha es un objeto con todas las etiquetas que tienen esa clase

for (let i in contenedorFecha) {
    let fechaTemp = contenedorFecha[i].textContent;
    contenedorFecha[i].textContent = humanizarFecha(fechaTemp)
}

// contenedorFecha.innerHTML = humanizarFecha(fechaActualizacion);
