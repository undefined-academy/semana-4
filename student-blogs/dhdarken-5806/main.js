...
const filterByTags = _.filter(entries, function (entry) {
  return _.includes(entry.tags, "Desarrollo");
});
//console.log(filterByTags);

const grupoActores = _.groupBy(filterByTags, "autor");
//console.log(grupoActores);

const titleAutor = _.mapValues(grupoActores, function (entries) {
  return _.map(entries, "titulo");
});
//console.log(titleAutor);
